...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/weakness \
  -H 'Content-Type: application/json' \
  -d '{"id":"79"}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/weakness`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
